  ...
  return (
    <main className="flex min-h-screen w-full justify-center">
      <div className="flex min-h-screen w-full max-w-7xl items-center justify-center p-6 md:p-10">
        <form className="w-full max-w-sm space-y-4 rounded-lg border border-muted-foreground/50 p-6 shadow-lg sm:p-8 lg:p-10">
          <div className="flex flex-col gap-6">
            ...
            <Button className="w-full py-5 font-semibold">Sign Up</Button>
          </div>
        </form>
      </div>
    </main>
